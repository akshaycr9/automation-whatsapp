...
import { isKnownMetaTemplateStatus, mapMetaTemplateStatus } from "../templates/providers/meta/meta-template.mapper.js";
...
export class WebhooksService {
  ...
  async handleMetaTemplateStatus(payload: unknown) {
    ...
    if (events.length === 0) {
      ...
      return { data: { processedCount: 0 }, message: "Webhook received" };
    }
    ...
    return { data: { processedCount }, message: "Webhook received" };
  }

  private extractTemplateStatusEvents(payload: unknown): TemplateStatusEvent[] {
